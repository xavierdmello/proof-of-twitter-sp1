...
// Circuit inputs generated from parsed email
// Generated by the node.js script in ../node-scripts/generate-dkim.js, using @zk-email/helpers
...
async fn prove(req_body: String) -> impl Responder {
    // Parse the request body JSON string into the ProveRequestBody struct
    ...
    // Parse the email and generate circuit inputs, then generate proof
...
async fn main() -> std::io::Result<()> {
    HttpServer::new(|| {
        let cors = Cors::permissive(); // permissive CORS for developnment only
        App::new()
            .wrap(cors)
...
// Call generate_dkim.js to parse email and return circuit inputs
